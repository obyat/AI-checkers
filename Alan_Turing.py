...
#                        maxix = maxix - 1
 #                       maxiy = maxiy - 1
                        ...
                        if maxiy == 0:
                            ...
                            by = by
                        print("\n\nmax x jump is: " +str(maxix) + "   ax is: "+str(ax))
                        print("max y jump is: " +str(maxiy)+ "   by is: "+str(by)+"\n\n"+
                             "boardWidth is: "+str(boardWidth) + ",   homewidth is: "+str(homeWidth)+ ",   (maxix) is: " + str(maxix))
                        print("boardHeight is: "+str(boardHeight) + ",   homeheight is: "+str(homeHeight)+ ",   (maxiy) is: " + str(maxiy))
                        #print("\n\nboardWidth - homeWidth - ax =>   ("  +str(boardWidth)+ " - " +str(homeWidth)+ " - " + str(ax)+ ") = " +str(boardWidth - homeWidth - ax) +" <--this is the score for x") 
                        #print("boardHeight - homeHeight - by =>   ("  +str(boardHeight)+ " - " +str(homeHeight)+ " - " + str(by)+ ") = " +str(boardHeight - homeHeight - by) +" <--this is the score for y")              
                        
                        #max([0, (boardWidth - homeWidth - ((x-1) + maxix))])
                        print("\n\nNum right moves/x score: "+str(max([1, (boardWidth - homeWidth - ax)])))
                        print("Num down moves/y score: "+str(max([0, (boardHeight - homeHeight - by)])))
