...
playerModuleList = [ 'Abdelrahman_Obyat','Alan']
#playerModuleList = ['Alan_Turing', 'A_O']
...
squareSize = 70    # Size of each square (pixels)
textHeight = 35     # Height of the text display at the top of the window (pixels)
pieceColors = [color_rgb(50, 50, 250), color_rgb(250, 120, 10)]
